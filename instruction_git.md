...
в ветку в которой сейчас находится пользователь добавляется информация из ветки <branch_name>

При слиянии веток может произойти конфликт (например если в обоих ветках в одинкаовых строках разная информация), конйликт решается путем выбора из нескольких вариантов:

1. Оставить все как в основной ветке
2. оставить только то, что переходит в основную ветку
3. оставить оба варианта из двух веток
